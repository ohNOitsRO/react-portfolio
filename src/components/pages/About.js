                ...
                <div className="col-md-8">
                    <div className="card">
                        <div className="card-body h-100">
                            <div className="lead">
                                <ul>
                                    <li className="listspace">Versatile Full-Stack Web Developer based in the vibrant city of Miami.  I strive to create simple, efficient, and elegant designs that engage users and bring their visions to life.
                                    </li>
